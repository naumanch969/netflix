            ...
            <div className="w-full px-[2rem] pt-[12px] pb-[2rem] " >
                ...
                <form className="newUserForm flex flex-wrap gap-[20px] " >
                    ...
                    <div className="newUserItem w-[25rem] flex flex-col">
                        ...
                        <input onChange={handleChange} value={userData.name} name='name' className="h-[20px] px-[12px] py-[20px] blist-[1px] blist-gray-500 rounded-[4px] " type="text" placeholder="Title" />
                    </div>
                    {/* username */}
                    <div className="newUserItem w-[25rem] flex flex-col">
                        <label className="mb-[10px] text-[16px] font-semibold text-lightGray " >username</label>
                        <input onChange={handleChange} value={userData.username} name='username' className="h-[20px] px-[12px] py-[20px] blist-[1px] blist-gray-500 rounded-[4px] " type="text" placeholder="Description" />
                    </div>
                    {/* status */}
                    <div className="w-full md:w-[25rem] flex flex-col ">
                        <label className="mb-[10px] text-[16px] font-semibold text-lightGray " >status</label>
                        <select multiple={false} onChange={handleChange} value={userData.status} className="newMovieSelect h-[40px] px-[12px] w-full rounded-[6px] blist-[1px] blist-gray-500 " name="inStock" id="active" >
                    ...
                    <div className="newUserItem w-[25rem] flex flex-col">
                        ...
                        <input onChange={handleChange} value={userData.email} name='email' className="h-[20px] px-[12px] py-[20px] blist-[1px] blist-gray-500 rounded-[4px] " type="text" placeholder="Price" />
                    </div>
                    {/* password */}
                    <div className="newUserItem w-[25rem] flex flex-col">
                        <label className="mb-[10px] text-[16px] font-semibold text-lightGray " >password</label>
                        <input onChange={handleChange} value={userData.password} name='categories' className="h-[20px] px-[12px] py-[20px] blist-[1px] blist-gray-500 rounded-[4px] " type="text" placeholder="jeans,skirts,etc..." />
                    </div>

                    {/* buttons */}
                    <div className=" w-full flex justify-start " >
                        <button onClick={handleCreateUser} className="w-[200px] blist-none bg-darkBlue text-white px-[12px] py-[8px] rounded-[8px] font-semibold cursor-pointer mt-[32px] ">
                            {'Create'}
                        </button>
                    </div>
