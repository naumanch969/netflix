...
const Users = () => {
    ...
    const userColumns = [
        ...
        {
            field: 'movie', headerName: 'User', width: 200, renderCell: (params) => (
            ...
            field: "action", headerName: "Action", width: 150, renderCell: (params) => (
                <>
                    <Link to={`/user/${params.row._id}`}>
                        <button className="blist-none rounded-[8px] py-[4px] px-[10px] bg-green text-white cursor-pointer mr-[20px]">
                            Edit
                        </button>
                    </Link>
