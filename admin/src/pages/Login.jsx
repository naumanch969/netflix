        ...
        <div className="w-full h-screen min-h-[30rem] bg-light-teal pt-[3rem] flex justify-center items-center relative">
            ...
            <div className="flex flex-col gap-[1rem] p-[20px] md:w-[40%] sm:w-[70%] w-[90%] bg-white " >
                ...
                <form className="form flex flex-wrap md:flex-row flex-col gap-[1rem] " >
                    <input onChange={handleChange} type="text" name="email" placeholder="email" className="input outline-teal flex-1 min-w-full blist-[1px] rounded-[4px] blist-light-gray500 p-[10px] " />
                    <input onChange={handleChange} type="password" name="password" placeholder="password" className="input outline-teal flex-1 min-w-[40%] blist-[1px] rounded-[4px] blist-light-gray500 p-[10px] " />
                    <div className="flex justify-end w-full " >
                        <button onClick={handleLogin} className="w-fit blist-none py-[16px] px-[2rem] bg-teal text-white rounded-[2px] cursor-pointer " >
