...
export const rawMovies = [
    { _id: 1, thumbnail: movie1, categories: ['category 1', 'category 11'], title: 'Air pods', inStock: false, price: '$38', createdAt: 'Sun Jun 1 2023 15:50:31' },
    { _id: 2, thumbnail: movie2, categories: ['category 2', 'category 22'], title: 'Bottle', inStock: true, price: '$3', createdAt: 'Mon Jul 10 2023 15:50:31' },
    { _id: 3, thumbnail: movie3, categories: ['category 3', 'category 33'], title: 'Headset', inStock: true, price: '$200', createdAt: 'Mon Sep 10 2023 15:50:31' },
    { _id: 4, thumbnail: movie4, categories: ['category 4', 'category 44'], title: 'Headset', inStock: true, price: '$300', createdAt: 'Mon Jul 10 2023 15:50:31' },
    { _id: 5, thumbnail: movie5, categories: ['category 5', 'category 55'], title: 'Camera', inStock: true, price: '$13', createdAt: 'Mon Jul 10 2023 15:50:31' },
    { _id: 6, thumbnail: movie6, categories: ['category 6', 'category 66'], title: 'Air pods', inStock: true, price: '$243', createdAt: 'Mon Aug 10 2023 15:50:31' },
    { _id: 7, thumbnail: movie7, categories: ['category 7', 'category 77'], title: 'Camera', inStock: false, price: '$103', createdAt: 'Tue Jan 10 2023 15:50:31' },
    { _id: 8, thumbnail: movie8, categories: ['category 8', 'category 88'], title: 'Chair', inStock: true, price: '$243', createdAt: 'Mon Dec 3 2023 15:50:31' },
    { _id: 9, thumbnail: movie9, categories: ['category 9', 'category 99'], title: 'Air pods', inStock: true, price: '$203', createdAt: 'Mon Mar 10 2022 15:50:31' },
    { _id: 10, thumbnail: movie10, categories: ['category 1', 'category 11'], title: 'Hand free', inStock: true, price: '$23', createdAt: 'Mon May 20 2023 15:50:31' },
]

export const rawLists = [
    {
        user: 'Ali Abbas',
        amount: '$453',
        status: 'pending',
